...
create_total_prawns <- function(raster_path=FALSE,
                          tif_path=FALSE,
...
#Three chained if statements, which trigger if there is a path to the appropriate file in the function call
  ...
  pollution_mean <- exact_extract(source_stack,transient,'sum')
...
# Rename the columns for readability --------------------------------------
    ...
    Nmdlst <- paste0("sum.",c("agric","domcom","energyprod","indcom","indproc","nature","offshore","othertrans","roadtrans","solvents","total","totarea","waste","pntsrc"),pollutant_data_name,last_two_digits_year)
