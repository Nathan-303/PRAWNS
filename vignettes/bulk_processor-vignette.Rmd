...
* It is calculated using the values predicted on the line of best fit, working out the values at deciles 1 and 10, calculating the differnce then expressing it as a percentage of the difference in the total line
